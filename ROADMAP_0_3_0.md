...
2. Compound and compressed scientific formats / 复合扩展名与压缩科研格式
   ...
   - Implemented: bounded NetCDF CDF-1/CDF-2/CDF-5 and TIFF/BigTIFF header evidence with no third-party dependency.
   - 已实现：无需第三方依赖的 NetCDF CDF-1/CDF-2/CDF-5 与 TIFF/BigTIFF 有界文件头证据。
