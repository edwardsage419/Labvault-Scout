...
2. Compound and compressed scientific formats / 复合扩展名与压缩科研格式
   ...
   - Implemented: bounded NetCDF CDF-1/CDF-2/CDF-5, TIFF/BigTIFF, FITS primary-header, and MATLAB Level 5 MAT-file evidence with no third-party dependency.
   - 已实现：无需第三方依赖的 NetCDF CDF-1/CDF-2/CDF-5、TIFF/BigTIFF、FITS primary header 与 MATLAB Level 5 MAT-file 有界证据。
